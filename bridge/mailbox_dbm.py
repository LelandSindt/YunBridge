...
class Mailbox:
  def __init__(self):
    self.incoming = deque()
    #self.data_store = { }
    #self.data_store = anydbm.open("/mnt/sd/arduino/bridge/mailbox", "c")
    #self.data_store['testing'] = 'joe'
  ...
  def data_store_put(self, k, v):
    #self.data_store[k] = v
    data_store = anydbm.open("/mnt/sd/arduino/bridge/mailbox", "c")
    data_store[k] = v
    data_store.close()
